...
from GenricApiViewApp.serializers import GnricsApiViewSerializers
...
class UploadDataView(ListCreateAPIView,RetrieveUpdateDestroyAPIView):
    queryset=BookStore.objects.using("default").all()
    serializer_class=GnricsApiViewSerializers
    ...
    def get_permissions(self):
        ...
        return permission
    @swagger_auto_schema(request_body=GnricsApiViewSerializers)
