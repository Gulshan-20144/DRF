...
from BaseSerializersApp.serializers import (BuyBooksSerializer)
...
class BuyBooksView(CreateModelMixin,RetrieveModelMixin,ListModelMixin,UpdateModelMixin,DestroyModelMixin,GenericViewSet):
    queryset=BookStore.objects.using("default").all()
    serializer_class=BuyBooksSerializer
    filter_fields=["name"]
