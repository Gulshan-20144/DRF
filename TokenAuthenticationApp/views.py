...
from ModelViewSetApp.serializers import ModelViewsetSerializers
...
class CustomObtainAuthToken(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'error': 'User with this email address does not exist'}, status=400)
...
class TokenAuthenticationsViewsetView(ModelViewSet):
    queryset=BookStore.objects.using("default").all()
    serializer_class=ModelViewsetSerializers
    filter_fields=["name"]
